...
const Disclaimer = () => {
  return (
    <div className="bg-secondary max-md:w-[100%] p-[70px_18px] md:p-[30px_20px] lg:p-[30px_60px] 2xl:p-[30px_290px] flex flex-col">
      ...
      <p
        className={`${manropeFont.className} text-[20px] lg:text-[24px] mt-[36px] text-primary`}
      >
        All artistic impressions, specifications, and details are indicative and
        subject to change without prior notice. All details must be verified
        with the developer or authorized representative.
      </p>

      <p
        className={`${manropeFont.className} text-[20px] lg:text-[24px] mt-[16px] text-primary`}
      >
