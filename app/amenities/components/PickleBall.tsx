...
const PickleBall = () => {
  ...
  return (
    <div className="w-full bg-primary relative gap-[10px] flex flex-col">
      ...
      <div className="w-full md:h-[80vh] p-[0px_0px] 2xl:p-[0px_200px] relative lg:gap-10 flex flex-col-reverse lg:flex-row justify-center bg-primary">
        <motion.div
      ...
      <div className="w-full md:h-[80vh] p-[0px_0px] 2xl:p-[0px_200px] relative lg:gap-10 flex flex-col-reverse lg:flex-row-reverse justify-center bg-primary">
        <motion.div
